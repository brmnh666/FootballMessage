...
public class Info {
    ...
    public static String getMonthAndDay() {
        ...
        if ((c.get(Calendar.MONTH) + 1) < 10) {
            mDate =  "0" + (c.get(Calendar.MONTH) + 1) + "月";
        } else {
            mDate =  (c.get(Calendar.MONTH) + 1) + "月";
        }
    ...
    public static String getTimebefore(String time) {
        String dateAndTime = Info.getDateAndTime();//获取当前时间
        ...
        if (time.substring(0, 10).equals(dateAndTime.substring(0, 10))) {
            ...
            //判断小时数如果小时数相等则显示几分钟之前
                 /*    if (time.substring(11,13).equals(dateAndTime.substring(11,13))){


                         int a = Integer.parseInt(dateAndTime.substring(14, 16));
                         int b= Integer.parseInt(time.substring(14, 16));

                         int c=a-b;

                         return "上次浏览在"+String.valueOf(c)+"分钟之前";

                     }else { //小时数不相等显示 几小时之前
                         int a= Integer.parseInt(dateAndTime.substring(11, 13));
                         int b=Integer.parseInt(time.substring(11, 13));

                         int c=a-b;
                         return "上次浏览在"+String.valueOf(c)+"小时之前";
                     }*/
           ...
           if (hour==0&&minuter!=0){
               return "上次浏览在"+minuter+"分"+second+"秒之前";
           }else if (hour!=0&&minuter!=0){
               return "上次浏览在"+hour+"个小时" + minuter + "分" + second + "秒之前";

           }
           else {

               return "上次浏览在"+second+"秒之前";
           }
           }


        //String timeb=dateAndTime.substring(11, 12);
        ...
        //几天前
            ...
            int c = a - b;
            return "上次浏览在" + String.valueOf(c) + "天前";
            ...
            int c = a - b;
            return "上次浏览在" + String.valueOf(c) + "个月之前";
            ...
            int c = a - b;
            return "上次浏览在" + String.valueOf(c) + "年之前";
