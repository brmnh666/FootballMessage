...
public class MyVideoView extends RelativeLayout {
    ...
    private void init() {
        ...
        videoView =  findViewById(R.id.my_videoview);
        playOrPauseCenterIv =  findViewById(R.id.my_video_center_playpause_iv);
        playControlLl =  findViewById(R.id.my_video_play_control_ll);
        playOrPauseIv =  findViewById(R.id.my_video_play_pause_iv);
        seekBar =  findViewById(R.id.my_video_seekbar);
        fullIv =  findViewById(R.id.my_video_full_iv);
        initSetting();
        initEvent();
    }
